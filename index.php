...
<body>
  ...
  <?php include './essentials/_aside.php'; ?>
        ...
        <div class="col-md-12">
          ...
          <div class="category-carousel swiper">
            <div class="swiper-wrapper">
              ...
              $query = "SELECT * FROM categories ORDER BY id"; // You can change this to suit your needs
            ...
            <a href="category.html" class="nav-link swiper-slide text-center">
                <img src="' . $row['image_url'] . '" class="rounded-circle" alt="Category Thumbnail">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
            ...
            <?php
            // Fetch products from the database
            $query = "SELECT * FROM products ORDER BY product_id DESC LIMIT 10"; // You can change this to suit your needs
            $result = $conn->query($query);
      ...
      <div class="product-item">
        <figure>
          <a href="index.html" title="Product Title">
            <img src="' . $row['image_url'] . '" alt="Product Thumbnail" class="tab-image">
          </a>
        </figure>
        <div class="d-flex flex-column text-center">
          <h3 class="fs-6 fw-normal">' . $row['name'] . '</h3>
          <div>
            <span class="rating">
          ...
          <div class="button-area p-3 pt-0">
            <div class="row g-1 mt-2">
              ...
              <div class="col-7"><a href="#" class="btn btn-primary rounded-1 p-2 fs-7 btn-cart" onclick="updateCart(\'add\', ' . $row['product_id'] . ');">
                <svg width="18" height="18">
                  <use xlink:href="#cart"></use>
                </svg> Add to Cart
              </a></div>
              <div class="col-2"><a href="#" class="btn btn-outline-dark rounded-1 p-2 fs-6" onclick="updateCart(\'add\', ' . $row['product_id'] . ');">
                <svg width="18" height="18">
  ...
  <script>
    ...
    .then(data => {
        // Assuming data contains the updated cart details
        console.log('Updated Cart:', data); // Check the data returned
        updateCartUI(data.cart); // Pass the cart details to the UI update function
    })
    .catch(error => {
...
function updateCartUI(cart) {
    ...
    cartList.innerHTML = ''; // Clear the existing cart

    // Check if cart is not empty
    if (cart.length > 0) {
        cart.forEach(item => {
            // Ensure that item properties exist and are not undefined
            const name = item.name || "Unknown Product";
            const description = item.description || "No description available";
            const price = item.price !== undefined ? `$${item.price}` : "Price not available";
    ...
    document.addEventListener('DOMContentLoaded', () => {
      // Fetch the cart data from the PHP script
      fetch('./api/cart.php')
        .then(response => response.json())
        .then(data => {
